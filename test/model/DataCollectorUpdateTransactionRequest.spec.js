...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorUpdateTransactionRequest();
  });
  ...
  describe('DataCollectorUpdateTransactionRequest', function() {
    it('should create an instance of DataCollectorUpdateTransactionRequest', function() {
      // uncomment below and update the code to test DataCollectorUpdateTransactionRequest
      //var instane = new KnetikIO.DataCollectorUpdateTransactionRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorUpdateTransactionRequest);
    });

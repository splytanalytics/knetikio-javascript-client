...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorNewUserRequest();
  });
  ...
  describe('DataCollectorNewUserRequest', function() {
    it('should create an instance of DataCollectorNewUserRequest', function() {
      // uncomment below and update the code to test DataCollectorNewUserRequest
      //var instane = new KnetikIO.DataCollectorNewUserRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorNewUserRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorNewDeviceRequest();
  });
  ...
  describe('DataCollectorNewDeviceRequest', function() {
    it('should create an instance of DataCollectorNewDeviceRequest', function() {
      // uncomment below and update the code to test DataCollectorNewDeviceRequest
      //var instane = new KnetikIO.DataCollectorNewDeviceRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorNewDeviceRequest);
    });

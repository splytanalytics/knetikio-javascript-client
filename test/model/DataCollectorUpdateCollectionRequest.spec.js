...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorUpdateCollectionRequest();
  });
  ...
  describe('DataCollectorUpdateCollectionRequest', function() {
    it('should create an instance of DataCollectorUpdateCollectionRequest', function() {
      // uncomment below and update the code to test DataCollectorUpdateCollectionRequest
      //var instane = new KnetikIO.DataCollectorUpdateCollectionRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorUpdateCollectionRequest);
    });
    ...
    it('should have the property balanceModification (base name: "balance_modification")', function() {
      // uncomment below and update the code to test the property balanceModification
      //var instane = new KnetikIO.DataCollectorUpdateCollectionRequest();
      //expect(instance).to.be();
    });

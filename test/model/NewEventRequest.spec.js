...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.NewEventRequest();
  });
  ...
  describe('NewEventRequest', function() {
    it('should create an instance of NewEventRequest', function() {
      // uncomment below and update the code to test NewEventRequest
      //var instane = new KnetikIO.NewEventRequest();
      //expect(instance).to.be.a(KnetikIO.NewEventRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorBatchRequest();
  });
  ...
  describe('DataCollectorBatchRequest', function() {
    it('should create an instance of DataCollectorBatchRequest', function() {
      // uncomment below and update the code to test DataCollectorBatchRequest
      //var instane = new KnetikIO.DataCollectorBatchRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorBatchRequest);
    });

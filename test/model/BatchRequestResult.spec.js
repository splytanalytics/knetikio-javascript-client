...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.BatchRequestResult();
  });
  ...
  describe('BatchRequestResult', function() {
    it('should create an instance of BatchRequestResult', function() {
      // uncomment below and update the code to test BatchRequestResult
      //var instane = new KnetikIO.BatchRequestResult();
      //expect(instance).to.be.a(KnetikIO.BatchRequestResult);
    });

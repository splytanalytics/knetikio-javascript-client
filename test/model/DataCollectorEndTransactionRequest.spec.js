...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorEndTransactionRequest();
  });
  ...
  describe('DataCollectorEndTransactionRequest', function() {
    it('should create an instance of DataCollectorEndTransactionRequest', function() {
      // uncomment below and update the code to test DataCollectorEndTransactionRequest
      //var instane = new KnetikIO.DataCollectorEndTransactionRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorEndTransactionRequest);
    });

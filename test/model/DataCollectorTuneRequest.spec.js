...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorTuneRequest();
  });
  ...
  describe('DataCollectorTuneRequest', function() {
    it('should create an instance of DataCollectorTuneRequest', function() {
      // uncomment below and update the code to test DataCollectorTuneRequest
      //var instane = new KnetikIO.DataCollectorTuneRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorTuneRequest);
    });

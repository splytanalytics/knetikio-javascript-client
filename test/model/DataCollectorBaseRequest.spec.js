...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DataCollectorBaseRequest();
  });
  ...
  describe('DataCollectorBaseRequest', function() {
    it('should create an instance of DataCollectorBaseRequest', function() {
      // uncomment below and update the code to test DataCollectorBaseRequest
      //var instane = new KnetikIO.DataCollectorBaseRequest();
      //expect(instance).to.be.a(KnetikIO.DataCollectorBaseRequest);
    });

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.UsersApi();
  });
  ...
  describe('UsersApi', function() {
    describe('newUser', function() {
      it('should call newUser successfully', function(done) {
        //uncomment below and update the code to test newUser
        //instance.newUser(function(error) {
    ...
    describe('updateUserState', function() {
      it('should call updateUserState successfully', function(done) {
        //uncomment below and update the code to test updateUserState
        //instance.updateUserState(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.MobileApplicationTrackingApi();
  });
  ...
  describe('MobileApplicationTrackingApi', function() {
    describe('submitTuneRequest', function() {
      it('should call submitTuneRequest successfully', function(done) {
        //uncomment below and update the code to test submitTuneRequest
        //instance.submitTuneRequest(function(error) {

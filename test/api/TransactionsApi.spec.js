...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.TransactionsApi();
  });
  ...
  describe('TransactionsApi', function() {
    describe('beginTransaction', function() {
      it('should call beginTransaction successfully', function(done) {
        //uncomment below and update the code to test beginTransaction
        //instance.beginTransaction(function(error) {
    ...
    describe('endTransaction', function() {
      it('should call endTransaction successfully', function(done) {
        //uncomment below and update the code to test endTransaction
        //instance.endTransaction(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

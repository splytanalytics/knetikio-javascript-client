...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KnetikIO.DebuggingApi();
  });
  ...
  describe('DebuggingApi', function() {
    describe('disableDebugger', function() {
      it('should call disableDebugger successfully', function(done) {
        //uncomment below and update the code to test disableDebugger
        //instance.disableDebugger(function(error) {
    ...
    describe('enableDebugger', function() {
      it('should call enableDebugger successfully', function(done) {
        //uncomment below and update the code to test enableDebugger
        //instance.enableDebugger(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();

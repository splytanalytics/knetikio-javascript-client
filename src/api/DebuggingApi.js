...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.DebuggingApi = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * Constructs a new DebuggingApi. 
   * @alias module:api/DebuggingApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     */
    this.disableDebuggerWithHttpInfo = function(customerId) {
      var postBody = null;

      // verify the required parameter 'customerId' is set
      if (customerId === undefined || customerId === null) {
        throw new Error("Missing the required parameter 'customerId' when calling disableDebugger");
      }
     ...
     */
    this.disableDebugger = function(customerId) {
      return this.disableDebuggerWithHttpInfo(customerId)
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.enableDebuggerWithHttpInfo = function(customerId) {
      var postBody = null;

      // verify the required parameter 'customerId' is set
      if (customerId === undefined || customerId === null) {
        throw new Error("Missing the required parameter 'customerId' when calling enableDebugger");
      }
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.enableDebugger = function(customerId) {
      return this.enableDebuggerWithHttpInfo(customerId)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }

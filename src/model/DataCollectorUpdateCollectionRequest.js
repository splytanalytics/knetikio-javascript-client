...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.DataCollectorUpdateCollectionRequest = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>DataCollectorUpdateCollectionRequest</code>.
   * @alias module:model/DataCollectorUpdateCollectionRequest
   * @class
   * @param balance {Number} Final balance after the transaction
   * @param balanceModification {Number} The amount changed (delta) in the transaction
   * @param currency {Boolean} Whether the unit being updated is a currency unit or not
   * @param eventTimestamp {Number} Epoch timestamp <i>in milliseconds</i> of when event itself occurred
   * @param name {String} Name of the unit/collection/currency being updated
   ...
   * @param userId {String} Unique ID of the new device
   */
  var exports = function(balance, balanceModification, currency, eventTimestamp, name, requestType, sendTimestamp, userId) {
    var _this = this;

    _this['balance'] = balance;
    _this['balance_modification'] = balanceModification;
  ...
  /**
   * Constructs a <code>DataCollectorUpdateCollectionRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataCollectorUpdateCollectionRequest} obj Optional instance to populate.
   * @return {module:model/DataCollectorUpdateCollectionRequest} The populated <code>DataCollectorUpdateCollectionRequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('balance_modification')) {
        obj['balance_modification'] = ApiClient.convertToType(data['balance_modification'], 'Number');
      }
  ...
  var discriminatorValue = 'DataCollectorUpdateCollectionRequest';
   ...
   * @member {Number} balance_modification
   */
  exports.prototype['balance_modification'] = undefined;
  /**

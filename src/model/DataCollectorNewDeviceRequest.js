...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.DataCollectorNewDeviceRequest = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>DataCollectorNewDeviceRequest</code>.
   * @alias module:model/DataCollectorNewDeviceRequest
   * @class
   * @param deviceId {String} Unique ID of the new device
  ...
  /**
   * Constructs a <code>DataCollectorNewDeviceRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataCollectorNewDeviceRequest} obj Optional instance to populate.
   * @return {module:model/DataCollectorNewDeviceRequest} The populated <code>DataCollectorNewDeviceRequest</code> instance.
   */
  ...
  var discriminatorValue = 'DataCollectorNewDeviceRequest';

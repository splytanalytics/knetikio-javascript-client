...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.DataCollectorNewUserRequest = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>DataCollectorNewUserRequest</code>.
   * @alias module:model/DataCollectorNewUserRequest
   * @class
   ...
   * @param userId {String} Unique ID of the new user
   */
  var exports = function(eventTimestamp, requestType, sendTimestamp, userId) {
    var _this = this;
  ...
  /**
   * Constructs a <code>DataCollectorNewUserRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataCollectorNewUserRequest} obj Optional instance to populate.
   * @return {module:model/DataCollectorNewUserRequest} The populated <code>DataCollectorNewUserRequest</code> instance.
   */
  ...
  var discriminatorValue = 'DataCollectorNewUserRequest';

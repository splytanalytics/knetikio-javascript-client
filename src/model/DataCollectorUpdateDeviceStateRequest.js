...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.DataCollectorUpdateDeviceStateRequest = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * The DataCollectorUpdateDeviceStateRequest model module.
   * @module model/DataCollectorUpdateDeviceStateRequest
   * @version 3.0.6
   */

  /**
   * Constructs a new <code>DataCollectorUpdateDeviceStateRequest</code>.
   * @alias module:model/DataCollectorUpdateDeviceStateRequest
   * @class
   * @param deviceId {String} Unique ID of the device for which state is being updated
   ...
   */
  var exports = function(deviceId, eventTimestamp, requestType, sendTimestamp) {
    var _this = this;
  ...
  /**
   * Constructs a <code>DataCollectorUpdateDeviceStateRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DataCollectorUpdateDeviceStateRequest} obj Optional instance to populate.
   * @return {module:model/DataCollectorUpdateDeviceStateRequest} The populated <code>DataCollectorUpdateDeviceStateRequest</code> instance.
   */
  ...
  var discriminatorValue = 'DataCollectorUpdateDeviceStateRequest';

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.BatchRequestResult = factory(root.KnetikIO.ApiClient, root.KnetikIO.DataCollectorBaseRequest);
  }
  ...
  /**
   * Constructs a new <code>BatchRequestResult</code>.
   * @alias module:model/BatchRequestResult
   * @class
   */
  ...
  /**
   * Constructs a <code>BatchRequestResult</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BatchRequestResult} obj Optional instance to populate.
   * @return {module:model/BatchRequestResult} The populated <code>BatchRequestResult</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('request')) {
        obj['request'] = DataCollectorBaseRequest.constructFromObject(data['request']);
      }
    }
    return obj;
  }
  ...
  var discriminatorValue = 'BatchRequestResult';
   ...
   * @member {module:model/DataCollectorBaseRequest} request
   */

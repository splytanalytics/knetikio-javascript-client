...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.KnetikIO.NewEventRequest = factory(root.KnetikIO.ApiClient);
  }
  ...
  /**
   * The NewEventRequest model module.
   * @module model/NewEventRequest
   * @version 3.0.6
   */

  /**
   * Constructs a new <code>NewEventRequest</code>.
   * @alias module:model/NewEventRequest
   * @class
   ...
   */
  var exports = function(eventTimestamp, requestType, result, sendTimestamp, category) {
    var _this = this;
  ...
  /**
   * Constructs a <code>NewEventRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewEventRequest} obj Optional instance to populate.
   * @return {module:model/NewEventRequest} The populated <code>NewEventRequest</code> instance.
   */
  ...
  var discriminatorValue = 'NewEventRequest';
